...
/* 
enum v4l2_priority { 
    V4L2_PRIORITY_UNSET       = 0,  // ����l��
    V4L2_PRIORITY_BACKGROUND  = 1,  // �I��
    V4L2_PRIORITY_INTERACTIVE = 2,  // ����
    V4L2_PRIORITY_RECORD      = 3,  // ����
    V4L2_PRIORITY_DEFAULT     = V4L2_PRIORITY_INTERACTIVE, 
}; 
ɬ���v�O���FMultiple Opens�ާ@�A��i�H���device�P�ɳQ�h��thread ���}(i.e open())
�ݭn�γo�u���v�h�Ϥ����Ӿާ@�󭫭n�A�ϥΪ������u���ŧO�A��prios[4]�N�[�@�C
*/ 
