...
static void authentication(void){
	...
	*/
	...
	/*
	ssid = "Test_ap";
	if(wifi_connect(ssid, RTW_SECURITY_OPEN, NULL, -1, NULL, NULL) == RTW_SUCCESS)
	...
	*/
	...
	if(wifi_connect(ssid, RTW_SECURITY_WEP_PSK, password, key_id, NULL, NULL) == RTW_SUCCESS)
		LwIP_DHCP(0, DHCP_START);
	*/
	...
	*/
	...
	//password = "AAAAAAAAAA";	// 10 HEX
	int key_id = 2; 	// value of key_id is 0, 1, 2, or 3.
	if(wifi_connect(ssid, RTW_SECURITY_WEP_SHARED, password, key_id, NULL, NULL) == RTW_SUCCESS)
		LwIP_DHCP(0, DHCP_START);
	*/
	...
	*/
	...
	ssid = "Test_ap";
	password = "12345678";
	if(wifi_connect(ssid, RTW_SECURITY_WPA_TKIP_PSK, password, -1, NULL, NULL) == RTW_SUCCESS)
		LwIP_DHCP(0, DHCP_START);
	*/
	...
	ssid = "Test_ap";
	password = "12345678";
	if(wifi_connect(ssid, RTW_SECURITY_WPA_AES_PSK, password, -1, NULL, NULL) == RTW_SUCCESS)
		LwIP_DHCP(0, DHCP_START);
	*/
	...
	ssid = "Test_ap";
	password = "12345678";
	if(wifi_connect(ssid, RTW_SECURITY_WPA2_TKIP_PSK, password, -1, NULL, NULL) == RTW_SUCCESS)
		LwIP_DHCP(0, DHCP_START);
	*/
	...
	ssid = "Test_ap";
	password = "12345678";
	if(wifi_connect(ssid, RTW_SECURITY_WPA2_AES_PSK, password, -1, NULL, NULL) == RTW_SUCCESS)
		LwIP_DHCP(0, DHCP_START);
	*/
